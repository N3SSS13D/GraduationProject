...
#include <stdint.h>
#include <stddef.h>
/* Preserve lwIP socket ioctl helpers while importing V4L2 ioctl macros. */
#ifdef _IO
#pragma push_macro("_IO")
#undef _IO
#define GP_IMAGE_TO_JPEG_RESTORE_IO 1
#endif
#ifdef _IOR
#pragma push_macro("_IOR")
#undef _IOR
#define GP_IMAGE_TO_JPEG_RESTORE_IOR 1
#endif
#ifdef _IOW
#pragma push_macro("_IOW")
#undef _IOW
#define GP_IMAGE_TO_JPEG_RESTORE_IOW 1
#endif
#include <linux/videodev2.h>

#ifdef GP_IMAGE_TO_JPEG_RESTORE_IO
#pragma pop_macro("_IO")
#undef GP_IMAGE_TO_JPEG_RESTORE_IO
#endif
#ifdef GP_IMAGE_TO_JPEG_RESTORE_IOR
#pragma pop_macro("_IOR")
#undef GP_IMAGE_TO_JPEG_RESTORE_IOR
#endif
#ifdef GP_IMAGE_TO_JPEG_RESTORE_IOW
#pragma pop_macro("_IOW")
#undef GP_IMAGE_TO_JPEG_RESTORE_IOW
#endif
